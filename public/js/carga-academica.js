...
/*!*****************************************!*\
  !*** ./resources/js/carga-academica.js ***!
  \*****************************************/
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  */
  ...
  var progressFill = document.getElementById('cargaProgressFill');
  var progressText = document.getElementById('cargaProgressText');
  var warning = document.getElementById('cargaWarning');
  ...
  */
  ...
  function renderPreguntas() {
    ...
    data.dimensiones.forEach(function (dimension) {
      ...
      seccion.innerHTML = "\n                <h3>".concat(dimension.titulo, "</h3>\n                <p class=\"carga-dimension-desc\">").concat(dimension.descripcion, "</p>\n            ");
  ...
  */
  ...
  function actualizarProgreso() {
    var preguntas = dimensionesContainer.querySelectorAll('.carga-question');
    var respondidas = 0;
  ...
  dimensionesContainer.addEventListener('change', function (event) {
    ...
    var opcionesDeLaPregunta = event.target.closest('.carga-question').querySelectorAll('.carga-option');
  ...
  */
  ...
  function calcularPorcentaje(nivel, puntaje) {
    ...
    var porcentaje = (puntaje - 18) / (90 - 18) * 100;
  ...
  function animarTermometro(nivel, puntaje, alTerminar) {
    ...
    var marks = document.querySelectorAll('.carga-thermo-marks .mark');
  ...
  */
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          primeraSinResponder = dimensionesContainer.querySelector('.carga-question:not(.answered)');
  ...
  btnRepetir.addEventListener('click', function () {
    ...
    document.querySelectorAll('.carga-option.selected').forEach(function (o) {
      return o.classList.remove('selected');
    });
    actualizarProgreso();
  ...
  function mostrarResultado(resultado) {
    ...
    document.querySelectorAll('.carga-thermo-marks .mark').forEach(function (m) {
    ...
    document.getElementById('resultRecursos').style.display = resultado.nivel === 'alta' || resultado.nivel === 'critica' ? 'block' : 'none';
    stepPreguntas.style.display = 'none';
